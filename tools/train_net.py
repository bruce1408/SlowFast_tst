...
def calculate_and_update_precise_bn(loader, model, num_iters=200):
    ...
    # Update the bn stats.
    # 如果输入数据不够 NUM_BATCHES_PRECISE 的时候,那么就会报错.源码部分使用的是itertools.islice(iterObject, num)
...
def train(cfg):
    ...
    if cfg.TRAIN.AUTO_RESUME and cu.has_checkpoint(cfg.OUTPUT_DIR):
        ...
        print('the output checkpoints is:', cfg.OUTPUT_DIR)
        print('the last checkpoint is: ', last_checkpoint)
    ...
    for cur_epoch in range(start_epoch, cfg.SOLVER.MAX_EPOCH):
        ...
        # Train for one epoch.
        print("cfg.TRAIN.CHECKPOINT_PERIOD", cfg.TRAIN.CHECKPOINT_PERIOD)
        print("curve_epoch: ", cur_epoch)
